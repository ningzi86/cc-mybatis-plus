...
public class MysqlGenerator {
    ...
    private static String packageClass = "mybatis";
    private static String projectName = "golango";
...
//                                 }
                        ...
                        .setUsername("root")
                        .setPassword("system")
                        .setUrl("jdbc:mysql://localhost:3306/tale?characterEncoding=utf8&serverTimezone=UTC")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
...
//                        .setSuperEntityClass("com.example.boot.base.BaseEntity")
                ...
                new PackageConfig()
                        ...
                        .setParent("cn." + projectName + "." + packageClass)// 自定义包路径
                ...
                new InjectionConfig() {
                    ...
                    public String outputFile(TableInfo tableInfo) {
                        return path + "/src/test/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
                    }
                }))
        ).setTemplate(
